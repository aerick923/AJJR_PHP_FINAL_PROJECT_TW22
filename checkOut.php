        ...
        <div class="lg:col-span-2 bg-slate-900 border border-slate-800 rounded-3xl p-8">
            ...
            <div class="grid md:grid-cols-2 gap-5">
                <div>
                    ...
                    <p class="font-bold mt-1"><?php echo $user['complete_name']; ?></p>
                </div>

                <div>
                    <p class="text-sm text-slate-400">Email Address</p>
                    <p class="font-bold mt-1"><?php echo $user['email']; ?></p>
                </div>

                <div>
                    <p class="text-sm text-slate-400">Contact Number</p>
                    <p class="font-bold mt-1"><?php echo $user['contact_number']; ?></p>
                </div>

                <div>
                    <p class="text-sm text-slate-400">Address</p>
                    <p class="font-bold mt-1"><?php echo $user['address']; ?></p>
                </div>
            </div>
            ...
            <div class="space-y-4">
                <?php foreach ($cart_items as $item) { ?>
                    <div class="flex justify-between bg-slate-950 border border-slate-800 rounded-2xl p-4">
                        <div>
                            <h3 class="font-bold"><?php echo $item['product']['product_name']; ?></h3>
                            <p class="text-sm text-slate-400">Quantity: <?php echo $item['quantity']; ?></p>
                        </div>

...
<div class="bg-slate-900 border border-slate-800 rounded-3xl p-12 text-center">
    ...
    <p class="text-slate-400 mt-3">
        Browse the store and add products.
    </p>

    <a href="store.php"
       class="inline-block mt-8 bg-cyan-400 hover:bg-cyan-300 text-slate-950 px-6 py-3 rounded-xl font-black transition">
...
<div class="grid md:grid-cols-5 gap-4 px-6 py-5 border-t border-slate-800 items-center">
    ...
    <div>
        ...
        <div class="w-24 bg-slate-950 border border-slate-700 rounded-xl px-3 py-2 text-center">
    ...
    <div class="text-right">
        ...
        <form method="POST"
            ...
            <button
                type="submit"
                class="bg-red-600 hover:bg-red-500 text-white px-4 py-2 rounded-xl font-bold transition">
...
<div class="border-t border-slate-800 px-6 py-6 flex flex-col md:flex-row justify-between items-center gap-6">
    ...
    <div class="text-right">
        ...
        <p class="text-4xl font-black text-cyan-400">

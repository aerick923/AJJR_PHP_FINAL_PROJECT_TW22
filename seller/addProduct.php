...
<div class="mb-8">
    ...
    <h1 class="text-4xl font-black mt-2">Add Product</h1>
    <p class="text-slate-400 mt-3">Create a new product for the store page.</p>
</div>
...
<div class="max-w-3xl bg-slate-900 border border-slate-800 rounded-3xl p-8">
    ...
    <form method="POST" class="space-y-5">
        <div>
            ...
            <input type="text" name="product_name" required class="w-full mt-2 bg-slate-950 border border-slate-700 rounded-xl px-4 py-3 outline-none focus:border-cyan-400">
        </div>
        ...
        <div>
            ...
            <textarea name="description" rows="4" class="w-full mt-2 bg-slate-950 border border-slate-700 rounded-xl px-4 py-3 outline-none focus:border-cyan-400"></textarea>
        </div>

        <div class="grid md:grid-cols-2 gap-5">
            <div>
                <label class="text-sm text-slate-300">Price</label>
                <input type="number" name="price" step="0.01" min="0" required class="w-full mt-2 bg-slate-950 border border-slate-700 rounded-xl px-4 py-3 outline-none focus:border-cyan-400">
            </div>

            <div>
                <label class="text-sm text-slate-300">Stock</label>
                <input type="number" name="stock" min="0" required class="w-full mt-2 bg-slate-950 border border-slate-700 rounded-xl px-4 py-3 outline-none focus:border-cyan-400">
            </div>
        </div>

        <div>
            <label class="text-sm text-slate-300">Image Filename</label>
            <input type="text" name="image" placeholder="example: rtx-3050.jpg" class="w-full mt-2 bg-slate-950 border border-slate-700 rounded-xl px-4 py-3 outline-none focus:border-cyan-400">
            <p class="text-xs text-slate-500 mt-2">Place the image inside your images/products folder later.</p>
        </div>

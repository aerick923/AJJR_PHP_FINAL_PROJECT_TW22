...
<body class="bg-slate-950 text-white min-h-screen">
    ...
    <header class="sticky top-0 z-50 bg-slate-950/80 backdrop-blur-lg border-b border-slate-800">
        <nav class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <div class="hidden md:flex items-center gap-7 text-sm font-medium">
                <a href="index.php" class="text-slate-300 hover:text-cyan-400 transition">Home</a>
    ...
    <section class="max-w-7xl mx-auto px-6 py-16">
        <div class="text-center mb-12">
            <p class="text-cyan-400 font-semibold">Meet the Team</p>
            <h2 class="text-4xl md:text-5xl font-black mt-3">Group Members</h2>
            <p class="text-slate-400 mt-4">
                Replace the names below with your real group members.
            </p>
        </div>

        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">

            <div class="bg-slate-900 border border-slate-800 rounded-3xl p-8 text-center hover:border-cyan-400 transition">
                <div class="w-20 h-20 mx-auto rounded-3xl bg-cyan-400 text-slate-950 flex items-center justify-center text-3xl font-black">
                    A
                </div>
                <h3 class="text-xl font-black mt-5">Member 1</h3>
                <p class="text-cyan-400 text-sm font-semibold mt-1">Frontend / Design</p>
                <p class="text-slate-400 text-sm mt-4">
                    Responsible for page layout, visual design, and TailwindCSS styling.
                </p>
            </div>
            ...
            <div class="bg-slate-900 border border-slate-800 rounded-3xl p-8 text-center hover:border-cyan-400 transition">
                ...
                <h3 class="text-xl font-black mt-5">Member 2</h3>
                <p class="text-cyan-400 text-sm font-semibold mt-1">Backend / PHP</p>
                <p class="text-slate-400 text-sm mt-4">
                    Responsible for PHP pages, form handling, and basic system logic.
                </p>
            </div>
            ...
            <div class="bg-slate-900 border border-slate-800 rounded-3xl p-8 text-center hover:border-cyan-400 transition">
                ...
                <h3 class="text-xl font-black mt-5">Member 3</h3>
                <p class="text-cyan-400 text-sm font-semibold mt-1">Database</p>
                <p class="text-slate-400 text-sm mt-4">
                    Responsible for MySQL database tables, products, users, and orders.
                </p>
            </div>
            ...
            <div class="bg-slate-900 border border-slate-800 rounded-3xl p-8 text-center hover:border-cyan-400 transition">
                ...
                <h3 class="text-xl font-black mt-5">Member 4</h3>
                <p class="text-cyan-400 text-sm font-semibold mt-1">Documentation / Testing</p>
                <p class="text-slate-400 text-sm mt-4">
                    Responsible for checking requirements, documentation, and website testing.
                </p>
            </div>

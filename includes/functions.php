...
<head>
    ...
    <title>
        <?= htmlspecialchars($page_title); ?> | AJJR Seller
    </title>
...
<header class="bg-slate-900 border-b border-slate-800">
    ...
    <div class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between gap-6">
        ...
        >
            ...
            <div>
                <h1 class="font-black text-lg leading-none text-white">
                    AJJR Seller
                </h1>
    ...
    <footer class="mt-20 border-t border-slate-800 bg-slate-950">
        ...
        <div class="max-w-7xl mx-auto px-6 py-10 text-center">
            ...
            <p class="text-slate-600 text-xs mt-5">
                © <?= date("Y"); ?> AJJR PC Parts. All rights reserved.
            </p>
